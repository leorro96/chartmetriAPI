...
class APICaller:
    ...
    #CURATOR
        ...
        #Curator List
    def getCuratorList(self, platform, offset=None, limit=None, sortColumn=None, sortOrderDescoptional=None, editorial=None, majorLabel=None, brand=None, popularIndie=None, indie=None, audiobook=None, withSocialUrls=None, code2=None, aggregated=None):
        getCuratorListResponse=f'https://api.chartmetric.com/api/curator/{platform}/lists{"?" if platform or limit or editorial or majorLabel or brand or popularIndie or indie or audiobook or withSocialUrls or code2 or aggregated else ""}{"platform="+platform if platform is not None else ""}{"&" if (platform is not None) and (offset or limit or editorial or majorLabel or brand or popularIndie or indie or audiobook or withSocialUrls or code2 or aggregated) is not None else ""}{"offset="+offset if offset is not None else ""}{"&" if (platform and offset is not None) and (editorial or majorLabel or brand or popularIndie or indie or audiobook or withSocialUrls or code2 or aggregated) is not None else ""}{"limit="+limit if limit is not None else ""}{"&" if (platform and limit is not None) and (editorial or majorLabel or brand or popularIndie or indie or audiobook or withSocialUrls or code2 or aggregated) is not None else ""}{"editorial="+editorial if editorial is not None else ""}{"&" if (platform and limit and editorial is not None) and (majorLabel or brand or popularIndie or indie or audiobook or withSocialUrls or code2 or aggregated) is not None else ""}{"majorLabel="+majorLabel if majorLabel is not None else ""}{"&" if (platform and limit and editorial and majorLabel is not None) and (brand or popularIndie or indie or audiobook or withSocialUrls or code2 or aggregated) is not None else ""}{"brand="+brand if brand is not None else ""}{"&" if (platform and limit and editorial and majorLabel and brand is not None) and (popularIndie or indie or audiobook or withSocialUrls or code2 or aggregated) is not None else ""}{"popularIndie="+popularIndie if popularIndie is not None else ""}{"&" if (platform and limit and editorial and majorLabel and brand and popularIndie is not None) and (indie or audiobook or withSocialUrls or code2 or aggregated) is not None else ""}{"indie="+indie if indie is not None else ""}{"&" if (platform and limit and editorial and majorLabel and brand and popularIndie and indie is not None) and (audiobook or withSocialUrls or code2 or aggregated) is not None else ""}{"audiobook="+audiobook if audiobook is not None else ""}{"&" if (platform and limit and editorial and majorLabel and brand and popularIndie and indie and audiobook is not None) and (withSocialUrls or code2 or aggregated) is not None else ""}{"withSocialUrls="+withSocialUrls if withSocialUrls is not None else ""}{"&" if (platform and limit and editorial and majorLabel and brand and popularIndie and indie and audiobook and withSocialUrls is not None) and (code2 or aggregated) is not None else ""}{"code2="+code2 if code2 is not None else ""}{"&" if (platform and limit and editorial and majorLabel and brand and popularIndie and indie and audiobook and withSocialUrls and code2 is not None) and (aggregated) is not None else ""}{"aggregated="+aggregated if aggregated is not None else ""}'
